...
return [
    'modules' => [
        ...
        'Best4Mage_DPPC' => 0,
        'Bss_CustomOptionCore' => 1,
        'Bss_CustomOptionAbsolutePriceQuantity' => 0,
        'Bss_CustomOptionImage' => 1,
        'Bss_CustomOptionImageFixBug' => 1,
        'Bss_CustomOptionTemplate' => 0,
        'Bss_CustomOptionTemplateFixBug' => 0,
        'Bss_DependentCustomOption' => 0,
        'Bss_DependentCOFixBug' => 0,
        'Bss_Gallery' => 1,
        'Bss_GalleryFixBug' => 1,
        'Bss_ProductLabel' => 1,
        'Codazon_AjaxLayeredNavPro' => 1,
        'Codazon_Core' => 1,
        'Codazon_GoogleAmpManager' => 0,
        ...
        'Magefan_AlternateHreflangGraphQl' => 1,
        ...
        'Magefan_SeoPlus' => 1,
        'Magefan_SeoExtra' => 1,
        'Magefan_SeoCrosslink' => 1,
        'Magefan_SeoRedirectRule' => 1,
        'Magefan_SeoRule' => 1,
        'Magefan_TwitterCards' => 1,
        'Magefan_WysiwygAdvanced' => 1,
        'Magefan_XmlSitemap' => 1,
        'Mageplaza_Core' => 1,
